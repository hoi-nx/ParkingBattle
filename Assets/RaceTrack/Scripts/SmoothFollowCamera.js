...
//đối tượng vật lý 
	var localVilocity =target.InverseTransformDirection(target.GetComponent.<Rigidbody>().velocity);
	//xoay cam khi vận tốc xe dưới -=05
	...
	var acc=target.GetComponent.<Rigidbody>().velocity.magnitude;
